    ...
    <>
      ...
      >
        ...
        <section style={{
          ...
          <a href={GET_PROTECTION_URL} className="care-page-btn-primary" aria-label="Submit a Concern" style={{ marginBottom: '12px' }}>
        ...
        <footer style={{
          ...
          <p style={{ color: '#475569', fontSize: '0.7rem' }}>
            We handle all concern data confidentially in line with your organisation's safeguarding policy.
          </p>
        </footer>
